...
- **18 个 CRT 滤镜** — 扫描线、屏幕弧度（向内凹）、色差、辉光、暗角、噪点、色温、像素化、RGB 荧光粉遮罩、水平波纹、隔行扫描抖动、荧光粉余晖，以及故障艺术：行撕裂、数据损坏、像素排序、VHS 跟踪条、置换扭曲、镜像撕裂
...
### 屏幕弧度
模拟 CRT 显像管的凹面屏幕：画面整体向内微凹。滤镜严格保持画布尺寸与画面比例，不裁剪、不产生透明空洞。

| 参数 | 范围 | 说明 |
|------|------|------|
| 弧度 | 0–100 | 向内凹深度（0 为平面，100 最深） |
| 圆角 | 0–100 | 屏幕圆角半径 |
